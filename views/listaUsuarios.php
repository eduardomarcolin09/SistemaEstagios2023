...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        ...
        <div class="flex items-center gap-x-4 justify-start w-6/12 mb-4">
            ...
            <a href="usuario.php" class="bg-verde-1 rounded-full p-2 focus:bg-zinc-50
            ...
            <table class="table-auto">
                ...
                <tbody class="text-sm">
                    ...
                    foreach ($usuarios as $usuario) {
                        ...
                        echo "<a href='Usuario.php?id=" . $usuario->getId() . "' class='bg-verde-1 rounded-md py-1 px-4 focus:bg-zinc-50
                     ...
                     hover:bg-verde-3 hover:border-verde-3'>
                        ...
                        echo "<a href='excluirUsuario.php?id=" . $usuario->getId() . "' class='bg-vermelho-1 rounded-md py-1 px-4 focus:bg-zinc-50
